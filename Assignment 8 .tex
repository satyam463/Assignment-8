...
\end{align}
 \section{solution}
 Call the first matrix $\vec{A}$ and the second matrix $\vec{B}$. The matrix $\vec{A}{'}$ is  row reduced echelon form of $\vec{A}$ is 
 \begin{align}
 ...
 \begin{align}
   ...
   \end{align}
   \begin{align}
   \implies rank(\vec{A}{'})=3 = n (order of matrix)
   \end{align}
   Therefore it has trivial solution i.e. (0,0,0)\\
   Now the matrix $\vec{B}{'}$ is row reduced echelon form of $\vec{B}$ is 
    \begin{align}
 ...
 \begin{align}
   ...
   \end{align}
   \begin{align}
   \implies rank(\vec{B}{'})=2< n (order of matrix)
   \end{align}
